...
public class BreakAndBuildGoal extends Goal
{
    ...
    private void reloadConfigValues()
    {
        ...
        Identifier blockId = Identifier.tryParse(configSnapshot.data().bridgeBlockId);
        if (blockId != null)
        ...
        Identifier placeSoundId = Identifier.tryParse(configSnapshot.data().placeSoundId);
        ...
        Identifier hitSoundId = Identifier.tryParse(configSnapshot.data().hitSoundId);
        if (hitSoundId != null)
        ...
        Identifier breakSoundId = Identifier.tryParse(configSnapshot.data().breakSoundId);
