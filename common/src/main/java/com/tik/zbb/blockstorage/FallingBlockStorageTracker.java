...
public final class FallingBlockStorageTracker
{
    ...
    static final class TrackerSavedData extends SavedData
    {
        ...
        {
            this(entries, PersistedEntry.CODEC.listOf().optionalFieldOf("entries", List.of()).codec());
        }

        TrackerSavedData(List<PersistedEntry> entries, Codec<List<PersistedEntry>> codec)
        {
            this.codec = codec;
