...
)
{
    ...
    public record Blocks(
            ...
            Map<ResourceLocation, Block> dimensionPlaceBlockMap,
            Map<ResourceLocation, Block> mobPlaceBlockOverrideMap,
    ...
    private static Map<ResourceLocation, Block> idBlockMap(Map<String, String> entries, BlockResolver blockResolver)
    {
        Map<ResourceLocation, Block> map = new HashMap<>();
    ...
    public interface BlockResolver
    {
        ...
        BlockResolver MINECRAFT = (rawValue, defaultBlock) ->
        {
            ...
            return BuiltInRegistries.BLOCK.containsKey(id) ? BuiltInRegistries.BLOCK.get(id) : defaultBlock;
        };
