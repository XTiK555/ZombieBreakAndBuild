...
public final class ResetConfigEditHandler implements ConfigEditHandler
{
    @Override
    public ConfigEditOperation operation()
    {
        return ConfigEditOperation.RESET;
    }
    ...
    public ConfigEditResult handle(ConfigEditRequest request, ConfigEditContext context)
    {
        ...
        return context.applyValue(request, descriptor, descriptor.defaultValue());
    }
}
