...
public final class MixinCompatibilityGameTests
{
    ...
    public static void displayAccessors(GameTestHelper helper)
    {
        ...
        helper.assertTrue(DisplayProbes.transformation(display).translation().equals(transformation.translation()),
    ...
    public static void nearestTargetThroughWall(GameTestHelper helper)
    {
        ...
        NearestAttackableTargetGoal<Villager> goal = new NearestAttackableTargetGoal<>(zombie, Villager.class, 0, true, false, (candidate, level) -> candidate == villager);
    ...
    public static void nearestTargetThroughWallPreservesOriginalSelector(GameTestHelper helper)
    {
        ...
        var acceptingGoal = new NearestAttackableTargetGoal<>(
                zombie, Villager.class, 0, true, false, (candidate, level) -> candidate == villager);
        var rejectingGoal = new NearestAttackableTargetGoal<>(
                zombie, Villager.class, 0, true, false, (candidate, level) -> false);
