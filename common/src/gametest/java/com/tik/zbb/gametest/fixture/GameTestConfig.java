...
public final class GameTestConfig
{
    ...
    {
        edit(helper, ConfigEditRequest.set(path(path), String.valueOf(value), ConfigWriteMode.RUNTIME_ONLY));
    }

    public static void put(GameTestHelper helper, String path, Object key, Object value)
    {
        edit(helper, ConfigEditRequest.add(path(path), key + "=" + value, ConfigWriteMode.RUNTIME_ONLY));
    }

    public static void add(GameTestHelper helper, String path, Object value)
    {
        edit(helper, ConfigEditRequest.add(path(path), String.valueOf(value), ConfigWriteMode.RUNTIME_ONLY));
    }

    public static void remove(GameTestHelper helper, String path, Object value)
    {
        edit(helper, ConfigEditRequest.remove(path(path), String.valueOf(value), ConfigWriteMode.RUNTIME_ONLY));
    }

    public static void clear(GameTestHelper helper, String path)
    {
        edit(helper, ConfigEditRequest.clear(path(path), ConfigWriteMode.RUNTIME_ONLY));
    }

    public static void reset(GameTestHelper helper, String path)
    {
        edit(helper, ConfigEditRequest.reset(path(path), ConfigWriteMode.RUNTIME_ONLY));
    }
    ...
    public static void restoreRuntimeDefaults(GameTestHelper helper)
    {
        edit(helper, ConfigEditRequest.resetAll(ConfigWriteMode.RUNTIME_ONLY));
    }
