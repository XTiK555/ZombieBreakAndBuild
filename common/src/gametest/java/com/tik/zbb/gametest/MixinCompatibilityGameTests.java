...
final class MixinCompatibilityGameTests
{
    ...
    static void blockAndAccessors(GameTestHelper helper)
    {
        ...
        helper.assertTrue(readDisplayTransformation(display).getTranslation().equals(transformation.getTranslation()),
                "Display transformation invoker did not update synced data");
        helper.assertTrue(invokePrivateInt(Display.class, display, "getTransformationInterpolationDuration") == 7,
                "Display interpolation duration invoker did not update synced data");
        helper.assertTrue(invokePrivateInt(Display.class, display, "getTransformationInterpolationDelay") == 3,
